...
<h4><a href="../logout.php" style="float:right; margin-right:40px; margin-top: -170px; color:#fff; font-size:20px;">Logout</a></h4>


<!--In order to take an input we need to make a form -->
<form method="POST" >
<!-- table for alignment -->
<table style="width:30%;" align="center" border="1" style="color:#fff;">
   <tr>
